                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="navbar">
                              <ul class="nav navbar-nav navbar-right">
                                      <li>
                                          <?php
                                            // Mendapatkan jumlah item yang ada di keranjang
                                            $keranjang = 'Keranjang Belanja: ' . $this->cart->total_items() . ' item' . ($this->cart->total_items() > 1 ? 's' : '');
                                          ?>
                                          <!-- Menampilkan link ke halaman detail keranjang -->
